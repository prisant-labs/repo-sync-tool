...
**B. Partial or specced, not built** - E-13 (tray menu) is now CODE-COMPLETE (P3-C, 2026-07-05: full six-item menu + close-to-tray + launch-aware visibility; dogfood verification pending, per [E-13-tray-menu/spec.md](E-13-tray-menu/spec.md)). E-17 (branch and PR intelligence) and E-18 (auto-update and distribution) are specced (2026-07-04) but not started; Phase 4 of the execution plan builds them.
