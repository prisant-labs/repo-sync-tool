...
| Groups (repo tags) | `groups` / `repo_groups` (store + IPC + GUI) | MUST (promoted 2026-06-30) | [E-16](E-16-groups/spec.md) | **Built** (a85e0fc backend, 51daaa7 frontend, both 2026-07-03; spec written retroactively at E-16; known defect BL-NI-22, the O(N) per-repo group query, plus the group-filter false-empty state tracked in the audit) |
...
| Quick actions (folder/terminal/editor/remote) | `repo_open_*` | MUST | E-03* | **Built, with open defects** (implemented 2026-07-03, commit 8fc806c; broken on Windows for every repo because `local_path` is stored canonicalized, `repo_open_remote` executes an unvalidated remote URL (a security defect), `open_editor`'s `cmd /C` is metacharacter-injectable and always reports success; see the audit findings 1-2, 8-9. Fixed in Phase 1 of [execution-plan.md](execution-plan.md)) |
...
| Tray + native menu | `tray.rs` | MUST | E-13 | **Partial** (bb353f9, 2026-07-03: Show + Quit shipped, plus left-click-show; Check All Now, Pause/Resume, Open recent, the Settings menu item, and close-to-tray remain, per [E-13-tray-menu/spec.md](E-13-tray-menu/spec.md); completion is Phase 3 of [execution-plan.md](execution-plan.md)) |
...
| Branch and PR intelligence | (not yet designed) | SHOULD (jp-ratified 2026-07-04) | [E-17](E-17-branch-intel/spec.md) | **Not started** |
...
**B. Partial or specced, not built** - E-13 (tray menu) shipped PARTIAL 2026-07-03 (Show/Quit and left-click-show only; four menu items plus close-to-tray remain, per [E-13-tray-menu/spec.md](E-13-tray-menu/spec.md); Phase 3 of [execution-plan.md](execution-plan.md) finishes it). E-17 (branch and PR intelligence) and E-18 (auto-update and distribution) are specced (2026-07-04) but not started; Phase 4 of the execution plan builds them.
...
3. **New features:** E-17 (branch and PR intelligence) and E-18 (auto-update and distribution), ratified 2026-07-04, not started. This is Phase 4 of the execution plan.
