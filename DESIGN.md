...
`switch`, plus `drawer`, `dialog`, `toast`), plus one RepoSync-authored primitive with no
shadcn equivalent, `data-table` (N2); the product-specific parts are below.
