...
`switch`, plus `drawer`, `dialog`, `toast`), plus two RepoSync-authored primitives with no
shadcn equivalent, `data-table` (N2) and `tabs` (N4); the product-specific parts are below.
